...
flags.DEFINE_string('num_classes', '', '28 or 63')
FLAGS = flags.FLAGS
...
def class_text_to_int_63(row_label):
    ...
    if row_label == 'pot':
        return 14
    if row_label == 'case headphones':
        return 15
    if row_label == 'electric cigarette':
        return 16
    if row_label == 'scissors':
        return 17
    if row_label == 'bottle':
    ...
    if row_label == 'detonator':
        return 31
    if row_label == 'suspicious device':
        return 32
    if row_label == 'fan':
        return 33
    if row_label == 'razor':
    ...
    if row_label == 'book':
        return 46
    if row_label == 'electric toothbrush':
        return 47
    if row_label == 'binoculars':
        return 48
    if row_label == 'jewelry':
        return 49
    if row_label == 'metal flask':
        return 50
    if row_label == 'suspicious pack':
        return 51
    if row_label == 'falshveer':
        return 52
    if row_label == 'mine':
    ...
    if row_label == 'сable':
        return 9
    if row_label == 'big headphones':
        return 58
    if row_label == 'keyboard':
        return 59
    if row_label == 'hammer':
        return 60
    if row_label == 'flammable':
        return 61
    if row_label == 'case with headphones':
        return 62
    if row_label == 'electronic cigarette':
        return 63
    # else:
    #     return None
